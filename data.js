const data = [
	...
	},
	{
		...
		price: 58.55,
		description:
			"Designed to deliver the highest water quality possible with maximum versatility and ease of use.Tidal™ Power Filters are designed from the ground up to provide your aquarium with high-quality, comprehensive filtration. They are easy to use and adaptable to a variety of aquarium conditions. With a host of features including a self-priming pump, dual water intake with surface skimmer, adjustable flow, maintenance monitor, self-cleaning impeller, and a filter basket that holds any kind of filtration media - and more of it - Tidal™ Power Filters are designed to deliver the highest water quality possible with maximum versatility and ease of use.",
		category: "Filtration",
